#!/bin/bash
# ============================================================================
# Red Team VAPT – Final with -sCV, Only One Credential
# ============================================================================
...
# Tests credential: InternalPentest1:Teq%Mezew9koy35
...
# Only one credential (your specified one)
CREDS=(
    "InternalPentest1:Teq%Mezew9koy35"
)
...
main() {
    echo -e "${BLUE}========================================${NC}"
    echo -e "${BLUE} Red Team VAPT – Final (Single Credential)${NC}"
